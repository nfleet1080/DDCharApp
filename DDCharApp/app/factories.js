...
dndapp.factory('DataService', function () {
            ...
            return [
 {
     ...
     "StartingEquip": [
         ...
         [[{ "Type": "Weapon", "id": 12, "ifProficient": false }, { "Type": "Gear", "id": 6, "ifProficient": false }], [{ "Type": "Equipment", "id": 5, "ifProficient": false }], [{ "Type": "Equipment", "id": 6, "ifProficient": false }]],
         [[{ "Type": "Pack", "id": 6, "ifProficient": false }], [{ "Type": "Pack", "id": 5, "ifProficient": false }]],
         [[{ "Type": "Armor", "id": 13, "ifProficient": false }]],
         [[{ "Type": "Category", "id": 4, "ifProficient": false }]],
     ],
 ...
 },
 {
     ...
     "StartingWealth": { "DieCount": 5, "Die": 4, "Multiplier": 10 },
     "StartingEquip": [
         [[{ "Type": "Armor", "id": 10, "ifProficient": false }], [{ "Type": "Armor", "id": 2, "ifProficient": false }, { "Type": "Weapon", "id": 37, "ifProficient": false }, { "Type": "Gear", "id": 4, "ifProficient": false }]],
         [[{ "Type": "Equipment", "id": 6, "ifProficient": false }], [{ "Type": "Armor", "id": 2, "ifProficient": false }], [{ "Type": "Armor", "id": 5, "ifProficient": true }]],
         [[{ "Type": "Weapon", "id": 12, "ifProficient": false }, { "Type": "Gear", "id": 6, "ifProficient": false }], [{ "Type": "Equipment", "id": 9, "ifProficient": false }]],
         [[{ "Type": "Pack", "id": 6, "ifProficient": false }], [{ "Type": "Pack", "id": 5, "ifProficient": false }]],
         [[{ "Type": "Armor", "id": 13, "ifProficient": false }]],
         [[{ "Type": "Category", "id": 4, "ifProficient": false }]],
     ],
